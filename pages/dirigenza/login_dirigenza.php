    ...
    <?php
        ...
        if(isset($_POST["cod_utente"]) && isset($_POST["pwd"])){
			...
			try {				
				...
				$istruzione="SELECT * FROM dirigenza WHERE id_dirigenza = '" . $usr . "' AND password = '" . $pwd . "';";
				...
				if($totale==0){
					...
					//AVVIO SESSIONE
					session_start();							
					$_SESSION['id_dirigenza'] = $row['id_dirigenza'];
					$_SESSION['nome'] = $row['nome'];
					$_SESSION['cognome'] = $row['cognome'];
					header("location: dirigenza_page.php");  //renderizza alla home		
				}
