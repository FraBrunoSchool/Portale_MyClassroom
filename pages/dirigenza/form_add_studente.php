...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="form_add_studente.php">Add Studente<span class="sr-only">(current)</span></a>
            </li>
            </ul>
        </div>
    </nav>
    ...
    ?>
    <h2 align="center">Nuovo Studente</h2>
    <div class="card" style="margin-left: 20%; margin-right: 20%; margin-top: 5%">
        <div class="card-body">
            <form action="add_studente.php" method = "POST" enctype = "multipart/form-data">
                ...
                <div class="form-group">
                    <label for="inputState">Seleziona la classe</label>
